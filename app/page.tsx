    ...
    <>
      ...
      <main>
        <section className="hero" id="inscripcion">
          <div>
            <div className="eyebrow">
              <span className="dot"></span> Instituto de Cultura Brasil Colombia
            </div>
          ...
          <div className="hero-panel">
            <div className="hero-photo">
              <div className="eyebrow">
                <span className="dot"></span> Cursos · Cultura · Comunidad
              </div>
        ...
        <section className="campus-section" id="sedes">
          ...
          <div className="campus-grid">
            <article className="campus-card campus-norte">
              ...
              <a href="#ciclos" className="btn btn-yellow">
                Ver cursos Norte
              </a>
            </article>
          ...
          <div className="course-grid">
            ...
            <article className="course-card">
              ...
              <div className="course-content">
                ...
                <p>
                  Avanza más rápido con programas intensivos y semi-intensivos.
                </p>
                <a href="#ciclos" className="btn btn-yellow">
                  Ver oferta
                </a>
            ...
            <article className="course-card">
              ...
              <div className="course-content">
                ...
                <a href="#nivel" className="btn btn-yellow">
                  Prepararme
                </a>
              </div>
            </article>
        ...
        <section className="test-section" id="nivel">
          <div className="test-box">
            <div>
              <div className="eyebrow">
                <span className="dot"></span> Mide en qué nivel estás
              </div>
        ...
        <section className="cycles-section" id="ciclos">
          ...
          <div className="cycle-grid">
            <article className="cycle-card">
              ...
              <h3>Curso Expresso</h3>
              <p>2 niveles en 1 mes. Ideal para avanzar rápido.</p>
      ...
      <footer>
        ...
        <div>
          ...
          <a href="#sedes">Sede Centro CITIU</a>
